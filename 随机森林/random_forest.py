...
#读取csv,获取训练集和测试集
train_data = pd.read_csv('E:\data_mining\eye_classification\data\eeg_train.csv')
test_data = pd.read_csv('E:\data_mining\eye_classification\data\eeg_test.csv')
...
create_submission(alg,trainingSet,trainingLabels,testSet,test_data,'E:\\data_mining\\eye_classification\\result\\random_forest\\random_forest_predict.csv')